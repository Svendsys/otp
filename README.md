...
| `codewords/` | The codeword vocabulary — 695 nouns across 22 categories and 333 modifiers, curated to be picturable, phonetically distinct, and readable by a non-native speaker. `build_lists.py` rebuilds it and explains the rules. |
